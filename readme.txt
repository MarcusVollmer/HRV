...
The present functions are originally made for Matlab R2015a. Errors may occur using older releases (at least R2014b required). Since v0.96 additional toolboxes are not required to run the basic analysis. The Image Processing Toolbox is required to use the 'picker'-functionality.
...
Other formats are possible to load. Please address your wishes to marcus.vollmer@uni-greifswald.de
